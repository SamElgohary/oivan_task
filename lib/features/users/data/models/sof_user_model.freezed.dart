...
mixin _$SofUserModel {
  ...
  int get reputation => throw _privateConstructorUsedError; // optional extras
...
/// @nodoc
@JsonSerializable()
class _$SofUserModelImpl extends _SofUserModel {
...
// optional extras
  ...
  @override
  String toString() {
    return 'SofUserModel(userId: $userId, displayName: $displayName, profileImage: $profileImage, reputation: $reputation, location: $location, acceptRate: $acceptRate)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, userId, displayName,
      profileImage, reputation, location, acceptRate);
...
abstract class _SofUserModel extends SofUserModel {
  const factory _SofUserModel(
          ...
          final String? location,
          @JsonKey(name: 'accept_rate') final int? acceptRate}) =
      _$SofUserModelImpl;
  const _SofUserModel._() : super._();
